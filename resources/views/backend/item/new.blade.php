                        ...
                        <form action="{{ route('backside.item.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            @csrf
                             ...
                             <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="file" id="photo_id" name="photo"> <div class="text-danger form-control-feedback"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="volumeid">
                                        <option> Choose ABV</option>
                                        @foreach($volumes as $volume)
                                            <option value="{{ $volume->id }}"> {{ $volume->range }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
