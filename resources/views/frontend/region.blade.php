				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<div class="row random">
							...
							@php
							$id=$regionitem->id;
							$codeno=$regionitem->codeno;

							$name=$regionitem->name;

							$photo=$regionitem->photo;

							$unitprice=$regionitem->price;
							$discount=$regionitem->discount;
							$abv=$regionitem->volume->range;
							$region=$regionitem->region->name;
							$brand=$regionitem->brand->name;
							$subcategoryname=$regionitem->subcategory->name;
