 ...
 <section class="hero-wrap hero-wrap-2" style="background-image: url('logo/back.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-no-pb py-3">
			<div class="container">
				<div class="row">
					<div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url(logo/people.jpg);">
					</div>
